...
export function orderConfirmationBuyer(ctx: EmailContext): EmailContent {
  ...
  return {
    ...
    html: `<div style="${baseStyle}">
      ...
      <p>Thanks for your order. We're verifying your payment now. Once it clears, we check your item, repack it and send it out to you. Every order is sold and shipped by zarketplace.</p>
