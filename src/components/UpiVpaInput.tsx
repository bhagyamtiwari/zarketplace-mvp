  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-2">
        <label className="text-[9px] font-black uppercase tracking-widest">UPI ID (VPA)</label>
        <input
          type="text"
          value={first}
        ...
        {touched && first && !firstValid && (
          <p className="text-[9px] font-bold uppercase tracking-widest text-red-600 flex items-center gap-1">
      ...
      <div className="flex flex-col gap-2">
        ...
        />
        {confirm && (
          <p className={cn('text-[9px] font-bold uppercase tracking-widest flex items-center gap-1', matches ? 'text-emerald-600' : 'text-red-600')}>
