...
const SEED: Array<{
  ...
  { title: 'Vintage Wrangler denim jacket', brand: 'Wrangler', price: 3100, category: 'Outerwear', gender: 'Unisex', size: 'L', condition: 'Worn' },
  ...
  { title: 'Vintage band tee, 1998 tour', brand: 'Vintage', price: 1800, category: 'Tops', gender: 'Unisex', size: 'L', condition: 'Worn', free: true },
  ...
  { title: 'Vans Old Skool black', brand: 'Vans', price: 2300, category: 'Shoes', gender: 'Unisex', size: 'UK 8', condition: 'Worn' },
